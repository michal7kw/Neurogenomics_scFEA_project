...
fileName='output/Stroke_flux_lambda_04.csv'
balanceName='output/Stroke_balance_lambda_04.csv'
EPOCH=100
...
geneExpr = pd.read_pickle('./input/geneExprStroke.pkl')
geneExprScale = pd.read_pickle('./input/geneExprStroke_transformed.pkl')
...
geneExprDf = pd.read_pickle('./input/geneExprStroke_df.pkl')
...
def myLoss(m, c, lamb1 = 0.4, lamb2= 0.4, lamb3 = 0.4, lamb4 = 0.4, geneScale = None, moduleScale = None):    
